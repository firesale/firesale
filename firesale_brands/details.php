...
class Module_Firesale_brands extends Module
{
    ...
    public function install()
    {
        ...
        if ($this->firesale->is_installed()) {
            ...
            $route = array('title' => 'Brand', 'slug' => 'brand', 'table' => 'firesale_brands', 'map' => 'brand/{{ slug }}/{{ pagination }}', 'route' => 'brand/([a-zA-Z0-9]+)(/[0-9]+)?', 'translation' => 'firesale_brands/front/index/$1$2');
