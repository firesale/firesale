						...
						<?php foreach($images as $image): ?>
							<div class="preview" id="image-<?php echo $image->id; ?>">
								<span class="imageHolder">
									<a href="<?php echo SITE_URL; ?>admin/firesale/products/delete_image/<?php echo $image->id; ?>" class="delete">x</a>
									<img src="<?php echo SITE_URL; ?>files/thumb/<?php echo $image->id; ?>/480/360" />
								</span>
