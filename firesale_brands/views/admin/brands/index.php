		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<?php echo anchor('admin/firesale/brands/edit/' . $brand['id'], lang('global:edit'), 'class="btn orange edit"'); ?>
                        <?php echo anchor('admin/firesale/brands/delete/' . $brand['id'], lang('global:delete'), array('class' => 'confirm btn red delete')); ?>
                    </td>
				</tr>
				<?php endforeach; ?>
			</tbody>
