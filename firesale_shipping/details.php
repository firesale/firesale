...
class Module_Firesale_shipping extends Module
{
    ...
    public function install()
    {
        if ($this->firesale->is_installed()) {
            ...
            $fields[] = array_merge($template, array('name' => 'lang:firesale:label_tax_band', 'slug' => 'tax_band', 'type' => 'relationship', 'extra' => array('max_length' => 5, 'choose_stream' => $taxes->id, 'default_value' => 1), 'required' => FALSE));
    ...
    public function upgrade($old_version)
    {
        ...
        if ($old_version < '1.2.2') {
            ...
            $fields[] = array('name' => 'lang:firesale:label_tax_band', 'slug' => 'tax_band', 'type' => 'relationship', 'extra' => array('max_length' => 5, 'choose_stream' => $taxes->id, 'default_value' => 1), 'required' => FALSE);
