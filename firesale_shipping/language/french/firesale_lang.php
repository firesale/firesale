<?php
	...
	// Labels
	$lang['firesale:label_save']		= 'Enregistrer';
	$lang['firesale:label_company']		= 'Société de transport';
	$lang['firesale:label_price_min']	= 'Prix (minimum)';
	$lang['firesale:label_price_max']	= 'Prix (maximum)';
	$lang['firesale:label_price_min_max']	= 'Prix (min. à max.)';
	$lang['firesale:label_weight_min_max']	= 'Poids (min. à max.)';
	$lang['firesale:label_weight_min']	= 'Poids (Minimum)';
	$lang['firesale:label_weight_max']	= 'Poids (Maximum)';
	$lang['firesale:label_weight_kg']	= 'Poids du produit (kg)';
