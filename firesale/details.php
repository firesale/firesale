...
class Module_Firesale extends Module {
	...
	public function routes($action)
	{
		...
		// Routes
		$routes   = array();
		$routes[] = array('id' => '7', 'title' => 'Category (Customisation)', 'slug' => 'category_custom', 'table' => '', 'map' => 'category/{{ type }}/{{ slug }}', 'route' => 'category/(order|style)/([a-z0-9]+)', 'translation' => 'firesale/front_category/$1/$2');
		...
		$routes[] = array('id' => '5', 'title' => 'Orders (Single)', 'slug' => 'orders_single', 'table' => 'firesale_orders', 'map' => 'users/orders/{{ id }}', 'route' => 'users/orders/([0-9]+)', 'translation' => 'firesale/front_orders/view_order/$1');
