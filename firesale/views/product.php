...
<?php endif; ?>
        ...
        <section class="product-details">
          <ul>
            <li class="availability"><strong><?php echo lang('firesale:product:label_availability'); ?></strong><span>{{ product.stock_status.value }} ({{ product.stock }})</span></li>
            <li class="model"><strong><?php echo lang('firesale:product:label_model'); ?></strong><span>{{ product.title }}</span></li>
