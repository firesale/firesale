		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo anchor('admin/faq/edit/' . $route['id'], lang('global:edit'), 'class="btn orange edit"'); ?>
                                            <?php echo anchor('admin/faq/delete/' . $route['id'], lang('global:delete'), array('class' => 'confirm btn red delete')); ?>
                                        </td>
				</tr>
				<?php endforeach; ?>
			</tbody>
