...
<?php endforeach; ?>
          ...
          <br />
          <a href="{{ url:base }}admin/firesale/products#stock_status/2" onclick='$.cookie("stock_status", null); $.cookie("stock_status",2);' class="btn blue"><span><?php echo lang('firesale:dashboard:view_more'); ?></span></a>
<?php else: ?>
...
<?php endforeach; ?>
          ...
          <br />
          <a href="{{ url:base }}admin/firesale/products#stock_status/3" onclick='$.cookie("stock_status", null); $.cookie("stock_status",3);' class="btn blue"><span><?php echo lang('firesale:dashboard:view_more'); ?></span></a>
<?php else: ?>
