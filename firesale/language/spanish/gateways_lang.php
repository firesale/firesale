...
$lang['firesale:gateways:2checkout:desc'] = '2Checkout.com es un servicio de procesamiento de pagos en línea que le ayuda a aceptar todas las tarjetas de crédito, tarjetas de débito, PayPal y más.';

// Authorize.Net SIM
$lang['firesale:gateways:authorize_net_sim:name'] = 'Authorize.Net SIM';
$lang['firesale:gateways:authorize_net_sim:desc'] = 'Método Integration Server (SIM)la API utiliza huella digital en la transacción de pago';

// Authorize.Net
$lang['firesale:gateways:authorize_net:name'] = 'Authorize.Net';
$lang['firesale:gateways:authorize_net:desc'] = 'Aceptar pagos en línea con tarjeta de crédito y cheque electrónico.';
...
$lang['firesale:gateways:dps_pxpost:desc'] = 'PX POST está diseñado para manejar las transacciones utilizando un HTTPS Post Request.';

// Dummy
$lang['firesale:gateways:dummy:name'] = 'FireSale Dummy';
$lang['firesale:gateways:dummy:desc'] = 'El proveedor de pago de FireSale dummy. Ejemplo de proceso (Autorizado solo para hacer pruebas de tarjeta de credito).';

// eWAY Shared
$lang['firesale:gateways:eway_shared:name'] = 'eWAY Shared Payments';
$lang['firesale:gateways:eway_shared:desc'] = 'Permite que sus clientes sean redireccionados vía FORM POST HTTP a una página de pago que se aloja con eWAY.';
...
$lang['firesale:gateways:paypal_pro:desc'] = 'PayPal Payments Pro ,solución de procesamiento para las empresas con 100+ pedidos/mes.';

// PayPal Express Checkout
$lang['firesale:gateways:paypal_express:name'] = 'PayPal Express Checkout';
$lang['firesale:gateways:paypal_express:desc'] = 'Rapido. Sin necesidad de poner datos de facturación, Paypal lo hace todo.';

// PayPal
$lang['firesale:gateways:paypal:name'] = 'PayPal Payments Standard';
$lang['firesale:gateways:paypal:desc'] = 'Facil, Seguro y Rapido';
