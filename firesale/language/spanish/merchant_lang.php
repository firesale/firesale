...
$lang = array(
    ...
    'merchant_first_name'					=> 'Primer apellido',
    'merchant_last_name'					=> 'Segundo apellido',
    'merchant_card_issue'					=> 'Código de verificación de tarjeta',
    'merchant_exp_month'					=> 'Mes de caducidad',
    'merchant_exp_year'						=> 'Año de caducidad',
    ...
    'merchant_insecure_connection'			=> 'Los datos de la tarjeta deben enviarse sobre una conexión segura.',
    'merchant_required'						=> 'El campo %s es obligatorio.',
    'merchant_invalid_card_no'				=> 'El número de tarjeta no es válido.',
    'merchant_card_expired'					=> 'La tarjeta ha caducado.',
    'merchant_invalid_status'				=> 'Estado de pago no válido',
    'merchant_invalid_method'				=> 'Método no soportado.',
    'merchant_invalid_response'				=> 'Respuesta no válida del proveedor de pago.',
    'merchant_payment_failed'				=> 'Falló el pago. Por favor, inténtalo de nuevo.',
