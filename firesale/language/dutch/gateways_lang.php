...
$lang['firesale:gateways:2checkout:desc']			= '2Checkout.com ondersteund: creditcard, PayPal en meer.';

// Authorize.Net SIM
$lang['firesale:gateways:authorize_net_sim:name']	= 'Authorize.Net SIM';
$lang['firesale:gateways:authorize_net_sim:desc']	= 'Server Integratie Methode (SIM) API gebruikt een transactie betaalings handtekening via een gehosted betalingsformulier en 128-bit SSL encryptie.';

// Authorize.Net
$lang['firesale:gateways:authorize_net:name']		= 'Authorize.Net';
$lang['firesale:gateways:authorize_net:desc']		= 'Authorize.Net ondersteund: creditcard en e-check.';

// DPS (PX Pay)
$lang['firesale:gateways:dps_pxpay:name']			= 'DPS (PX Pay)';
$lang['firesale:gateways:dps_pxpay:desc']			= 'DPS PX Pay Gateway voor Australia en New Zealand.';
...
$lang['firesale:gateways:dummy:desc']				= 'The FireSale ondersteund: test betalingen.';
...
$lang['firesale:gateways:cardsave:desc']			= 'CardSave maakt het mogelijk om creditkaarten te verwerken.';

// Rabo OmniKassa
$lang['firesale:gateways:rabo_omnikassa:name']		= 'Rabo OmniKassa';
$lang['firesale:gateways:rabo_omnikassa:desc']		= 'Nederlandse betalingsmethode.';
