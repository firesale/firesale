<?php
	...
	$lang['firesale:sections:currency']       				= 'Devise';
	...
	$lang['firesale:tabs:assignments']  					= 'Affectations';
	...
	$lang['firesale:shortcuts:add_tax_band']    				= 'Ajouter une valeur de taxes';
	$lang['firesale:shortcuts:assign_taxes']    				= 'Affecter des taxes';
	...
	// Product Modifiers
	$lang['firesale:prod_modifiers:title'] 					= 'Modificateurs';
	...
	$lang['firesale:label_mod_single']    					= 'Produit unique';
	...
	$lang['firesale:label_cur_code']        				= 'Code devise';
	$lang['firesale:label_cur_code_inst']   				= 'Format ISO-4217';
	$lang['firesale:label_cur_tax']         				= 'Taux de taxe';
	$lang['firesale:label_cur_mod']         				= 'Modificateur de devise';
	...
	$lang['firesale:label_cur_format']      				= 'Format de la devise';
	$lang['firesale:label_cur_format_inst'] 				= 'Mettez en forme l\'affichage de la devise en incluant le symbole et le prix sous la forme "{{ price }}". Ex : {{ price }} € ou encore £ {{ price }}.';
	...
	$lang['firesale:label_tax_band']  					= 'Valeur de taxes';
	...
	$lang['firesale:orders:status_mismatch']				= 'Incomplète';
	...
	$lang['firesale:orders:logged_in']					= 'Vous devez être connecté(e) pour votre l\'historique de vos commandes.';
	...
	$lang['firesale:gateways:warning'] 					= 'Tous les paramètres de la plateforme seront perdus et votre système ne pourra plus recevoir de paiement ! Etes-vous sûr(e) de vouloir supprimer cette plateforme ?';
	$lang['firesale:gateways:multiple_warning'] 				= 'Tous les paramètres de la plateforme seront perdus et votre système ne pourra plus recevoir de paiement ! Etes-vous sûr(e) de vouloir supprimer les plateformes sélectionnées ?';
	...
	$lang['firesale:cart:login_required']					= 'Vous devez être connecté(e) pour effectuer cette action';
	...
	$lang['firesale:checkout:previous']					= 'Précédent';
	$lang['firesale:checkout:select_shipping_method'] 			= 'Merci de sélectionner ci-dessous le mode de livraison souhaité avant de continuer';
	$lang['firesale:checkout:select_payment_method'] 			= 'Merci de sélectionner ci-dessous le mode de paiement souhaité avant de continuer';
	$lang['firesale:checkout:submit_and_pay']				= 'Envoyer &amp; Payer';
	...
	// Route Labels
	$lang['firesale:routes:category_custom'] 				= 'Mise en forme de catégorie';
	$lang['firesale:routes:category']        				= 'Catégorie';
	$lang['firesale:routes:product']         				= 'Produit';
	$lang['firesale:routes:cart']            				= 'Panier';
	$lang['firesale:routes:order_single']    				= 'Commande unique';
	$lang['firesale:routes:orders']          				= 'Commandes de l\'utilisateur';
	$lang['firesale:routes:addresses']       				= 'Adresses de l\'utilisateur';
	$lang['firesale:routes:currency']        				= 'Permuteur de devises';

	// Currency
	$lang['firesale:shortcuts:install_currency'] 				= 'Installer une devise';
	$lang['firesale:currency:enable']            				= 'Activer';
	$lang['firesale:currency:disable']           				= 'Désactiver';
	$lang['firesale:currency:disable_warn']      				= 'Désactiver une devise peut causer des problèmes avec d\'éventuelles commandes antérieures';
	$lang['firesale:currency:delete']            				= 'Supprimer';
	$lang['firesale:currency:delete_warn']       				= 'Supprimer une devise peut causer des problèmes avec d\'éventuelles commandes antérieures';
	$lang['firesale:currency:create']            				= 'Ajouter une nouvelle devise';
	$lang['firesale:currency:edit']              				= 'Modifier devise';
	$lang['firesale:currency:not_found']         				= 'Devise sélectionnée introuvable';
	$lang['firesale:currency:add_success']    	   			= 'Nouvelle devise ajoutée';
	$lang['firesale:currency:add_error']         				= 'Impossible d\'ajouter la nouvelle devise';
	$lang['firesale:currency:edit_success']      				= 'Devise modifiée';
	$lang['firesale:currency:edit_error']        				= 'Impossible de modifier la devise';
	$lang['firesale:currency:delete_success']    				= 'La devise a bien été supprimée';
	$lang['firesale:currency:delete_error']      				= 'Une erreur est survenue durant la suppression de la devise';
	...
	// Taxes
	$lang['firesale:taxes:none']       	           			= 'Aucune valeur de taxes n\'est pour l\'instant paramétrée';
	$lang['firesale:taxes:new']             	      			= 'Ajouter une valeur de taxes';
	$lang['firesale:taxes:edit']                  				= 'Editer une valeur de taxes';
	$lang['firesale:taxes:add_success']           				= 'La valeur de taxes a bien été créée';
	$lang['firesale:taxes:add_error']             				= 'Une erreur est survenue durant la création de la valeur de taxes';
	$lang['firesale:taxes:edit_success']          				= 'La valeur de taxes a bien été éditée';
	$lang['firesale:taxes:edit_error']            				= 'Une erreur est survenue durant l\'édition de la valeur de taxes';
	$lang['firesale:taxes:assignments_updated']   				= 'Les affectations de valeur de taxes ont bien été mises à jour';
	...
	$lang['firesale:addresses:no_user']      				= 'Vous devez être connecté(e) pour gèrer vos adresses';
	...
	$lang['firesale:cart:button_goto_checkout'] 				= "Effectuer le paiement";
	...
	$lang['firesale:settings_currency_inst']         			= 'Code de devise à appliquer (au format ISO-4217, ex : EUR, USD, GBP, ...)';
	$lang['firesale:settings_currency_key']          			= 'Clé API de la devise';
	...
	$lang['firesale:settings_current_currency']     	 		= 'Devise courante';
	$lang['firesale:settings_current_currency_inst']	 		= 'La devise courante utilisée, utilisée pour mettre à jour les devises existantes si la devise par défaut est changée';
	$lang['firesale:settings_currency_updated']      			= 'Dernière mise à jour';
	$lang['firesale:settings_currency_updated_inst'] 			= 'Dernière mise à jour de la devise, l\'API met à jour les devises une seule fois par heure';
